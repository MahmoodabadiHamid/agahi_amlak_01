...
def start(bot, update):
    try:  
        ...
        txt1+=name + ' '
        txt1 += 'عزيز'+'\n' + 'به فایلینگ  مسکن ملت فایل خوش آمدید.2500 تومان اعتبار رایگان به شما تعلق گرفت (معادل یک هفته استفاده از فایلینگ) برای عضویت و دریافت فایل شماره تماس ملت فایل را ذخیره و پیام زیر را برایش فوروارد کنید. با تشکر شماره تماس ملت فایل \n 09195835818 \n آی دی ملت فایل در تلگرام \n @MelatFileAdmin'
